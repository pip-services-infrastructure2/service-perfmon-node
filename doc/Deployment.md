...
var plugin = require('service-perfmon-node').PerfMonSenecaPlugin;
...
or by using [PerfMonSenecaClient](https://github.com/pip-services-infrastructure2/client-counters-node/NodeClientApiV1.md/#client_seneca)