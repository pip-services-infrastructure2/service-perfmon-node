...
const PerfMonCommandableHttpServiceV1_1 = require("../services/version1/PerfMonCommandableHttpServiceV1");
class PerfMonServiceFactory extends pip_services3_components_nodex_1.Factory {
    constructor() {
        ...
        this.registerAsType(PerfMonServiceFactory.HttpServiceDescriptor, PerfMonCommandableHttpServiceV1_1.PerfMonCommandableHttpServiceV1);
    }
}
...
PerfMonServiceFactory.HttpServiceDescriptor = new pip_services3_commons_nodex_1.Descriptor("service-perfmon", "service", "commandable-http", "*", "1.0");
